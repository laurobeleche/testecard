...
In order to support loading of multiple wallets in bitcoincard-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoincard.cpp.
...
Changes to bitcoincard.cpp
----------------------
bitcoincard.cpp is the entry point into bitcoincard-qt, and as such, will require some minor modifications to provide hooks for
