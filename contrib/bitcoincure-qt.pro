...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoincard-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcoincard-cli.cpp \
           src/bitcoincard-tx.cpp \
           src/bitcoincard.cpp \
           src/db.cpp \
           ...
           src/qt/bitcoincard.cpp \
           src/qt/bitcoincardstrings.cpp \
...
RESOURCES += src/qt/bitcoincard.qrc src/qt/bitcoincard_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoincard_bg.ts \
                src/qt/locale/bitcoincard_de.ts \
                src/qt/locale/bitcoincard_en.ts \
                src/qt/locale/bitcoincard_es.ts \
                src/qt/locale/bitcoincard_fi.ts \
                src/qt/locale/bitcoincard_fr.ts \
                src/qt/locale/bitcoincard_it.ts \
                src/qt/locale/bitcoincard_ja.ts \
                src/qt/locale/bitcoincard_pl.ts \
                src/qt/locale/bitcoincard_pt.ts \
                src/qt/locale/bitcoincard_ru.ts \
                src/qt/locale/bitcoincard_sk.ts \
                src/qt/locale/bitcoincard_sv.ts \
                src/qt/locale/bitcoincard_vi.ts \
                src/qt/locale/bitcoincard_zh_CN.ts \
                src/qt/locale/bitcoincard_zh_TW.ts
