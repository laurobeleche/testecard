...
/** Utility functions used by the BitcoinCard Qt UI.
 */
namespace GUIUtil
{
...
// Render BitcoinCard addresses in monospace font
...
// Parse "bitcoincard:" URI into recipient object, return true on successful parsing
