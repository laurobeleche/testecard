...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinCard Core"),
     ...
     * override -datadir in the bitcoincard.conf file in the default data directory
     * (to be consistent with bitcoincardd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
