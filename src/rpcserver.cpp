...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitcoinCard server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BitcoinCard server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitcoincard features */
        {"bitcoincard", "masternode", &masternode, true, true, false},
        {"bitcoincard", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoincard", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoincard", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoincard", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoincard", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoincard", "startmasternode", &startmasternode, true, true, false},
        {"bitcoincard", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoincard", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoincard", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoincard", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoincard", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoincard", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoincard", "mnbudget", &mnbudget, true, true, false},
        {"bitcoincard", "preparebudget", &preparebudget, true, true, false},
        {"bitcoincard", "submitbudget", &submitbudget, true, true, false},
        {"bitcoincard", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoincard", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoincard", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoincard", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoincard", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoincard", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoincard", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoincard", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoincard", "mnsync", &mnsync, true, true, false},
        {"bitcoincard", "spork", &spork, true, true, false},
        {"bitcoincard", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcoincard", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcoincardd, or the -server option to bitcoincard-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitcoincard-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39898/\n";
}
