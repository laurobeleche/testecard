...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitcoincard Core bitcoincard-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoincard-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoincard transaction") + "\n" +
                               "  bitcoincard-tx [options] -create [commands]   " + _("Create hex-encoded bitcoincard transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoincard transaction
