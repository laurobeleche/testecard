Contributing to BitcoinCard Core
============================

The BitcoinCard Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinCard Core project, and is not to be
confused with overall BitcoinCard Network Protocol consensus changes.

Whether a pull request is merged into BitcoinCard Core rests with the project merge
...
Patches that change BitcoinCard consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinCard consensus, it must have been
...
The project leader is the release manager for each BitcoinCard Core release.
